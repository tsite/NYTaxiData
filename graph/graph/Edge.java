...
public class Edge {
    ...
    private final String roadClass, type, name, ref;//secondary, tertiary, etc..
	public final long directed;
    ...
    public Edge(Coordinates aCoordsFrom, Coordinates aCoordsTo, String aRoadClass,String aType,
            long isDirectedFlag, boolean isTunnelFlag, boolean isBridgeFlag, String aName, String ref1){
